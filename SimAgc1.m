...
%     load('BatData1.mat');
%     load(fileName);
% load('test111.mat');     % 载入文件

load('SHDdata.mat')
data=SHDdata.data1228(1:2:end,4:6);
Agc=data(:,1);% AGC指令
Pdg=data(:,2);% 机组出力
...
SOC = 85.0;
SOC0 = SOC;
Para = [2,200,Pmax,Pmin,(0.05*Pmax),50.0,5.0,5.0,100.0,00.0,Emax,Prate,0.01*Prate,0.005];
